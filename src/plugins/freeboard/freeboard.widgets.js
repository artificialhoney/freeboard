  ...
  function easeTransitionText(newValue, textElement, duration) {
    ...
    if ($.isNumeric(newValue) && $.isNumeric(currentValue)) {
      ...
      jQuery({
        ...
        { transitionValue: Number(newValue), precisionValue: endingPrecision },
        {
          duration: duration,
          step: function () {
            $(textElement).text(
  ...
  var textWidget = function (settings) {
    ...
    function updateValueSizing() {
      if (
        ...
        valueElement.css(
          "max-width",
          displayElement.innerWidth() - unitsElement.outerWidth(true) + "px",
        );
      } else {
  ...
  var gaugeWidget = function (settings) {
    ...
    this.render = function (element) {
      ...
      $(element)
        .append(titleElement)
        .append(
          $('<div class="gauge-widget-wrapper"></div>').append(gaugeElement),
        );
      createGauge();
    };
  ...
  var googleMapWidget = function (settings) {
    ...
    function updatePosition() {
      if (map && marker && currentPosition.lat && currentPosition.lon) {
        var newLatLon = new google.maps.LatLng(
          currentPosition.lat,
          currentPosition.lon,
        );
