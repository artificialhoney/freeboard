export const ValueEditor = function (theFreeboardModel) {
  ...
  function _renderAutocompleteDropdown(element, expectsType) {
    ...
    _autocompleteFromDatasource(
      inputString,
      theFreeboardModel.datasources(),
      expectsType,
    );
    ...
    if (_autocompleteOptions.length > 0) {
      ...
      _.each(_autocompleteOptions, function (option, index) {
        var li = _renderAutocompleteDropdownOption(
          element,
          inputString,
          option,
          index,
  ...
  function _renderAutocompleteDropdownOption(
    element,
    inputString,
    option,
    currentIndex,
